                ...
                @auth
                    ...
                    <form action="{{ route('comentarios.store', ['post' => $post, 'user' => $user]) }}" method="post">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="comentario" id="comentario" placeholder="Descripción del comentario" class="border p-3 w-full rounded-lg @error('comentario') border-red-600 @enderror"></textarea>
                            @error('comentario')
